...
jQuery(function(){
    ...
    var dps3 = new Date();    
	dps3.setDate(dps3.getDate()-1);
    jQuery('#dps3').datepicker({
				weekStart: 1,
			    startDate: dps3,
			    autoclose: true
			}).on('changeDate', function(ev){
	...
	contract.setDate(contract.getDate()-1);
	...
	jQuery('#dp4').datepicker({
			...
			jQuery('#dp5').datepicker('setStartDate', startDate);
	...
	var sdp1 = new Date();
	sdp1.setDate(startDate.getDate());
	// var endDate = new Date();
	jQuery('#sdp1').datepicker({
			weekStart: 1,
		    startDate: sdp1,
		    autoclose: true
		}).on('changeDate', function(ev){
			sdp1 = new Date(ev.date.valueOf());
    		sdp1.setDate(sdp1.getDate(new Date(ev.date.valueOf())));
			jQuery('#sdp2').datepicker('setStartDate', sdp1);
	});  

	jQuery('#sdp2').datepicker({
				weekStart: 1,
			    startDate: sdp1,
			    autoclose: true
			}).on('changeDate', function(ev){
