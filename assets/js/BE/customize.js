...
jQuery(function(){
	...
	jQuery(".actOnchange").bind("change", function(e){
		e.preventDefault();
		var dateOfCos = jQuery("#cus-date").val();
	...
	jQuery(".accOnchange").bind("change", function(e){
		e.preventDefault();
		var dateOfCus = jQuery("#cus-date").val();
		var url_SubEp = jQuery(this).attr("data-url");
	...
	jQuery('.checkbox_all_cus_act, .checkbox_all_cus_tps, .checkbox_all_cus_acc, .checkbox_all_cus_epacc, .checkbox_all_cus_epact, .checkbox_all_cus_eptps').bind('click', function(){
	...
	jQuery(".frm_cus_act").bind('submit', function(){
	...
	jQuery(".frm_cus_acc").bind('submit', function(){
	...
	// form pop up submit while add accommodation
	jQuery(".frm_cus_tps").bind('submit', function(){
