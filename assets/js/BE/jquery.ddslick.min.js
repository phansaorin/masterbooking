...
var c={},
	...
	embedCSS:true,
	onSelected:function(){}},
	i='<div class="dd-select"><input name="txtPhotos" class="dd-selected-value" type="hidden" /><a class="dd-selected"></a><span class="dd-pointer dd-pointer-down"></span></div>',
	...
	c.init=function(l){
		...
		return this.each(function(){
			...
			q=p.data("ddslick");
			if(!q){var n=[],
				o=l.data;p.find("option").each(function(){
					var w=e(this),
					v=w.data();
					n.push({
						text:e.trim(w.text()),
				...
				p.replaceWith(s);p=s;p.addClass("dd-container").append(i).append(a);
				...
				if(l.height!=null){
					...
					var t={settings:l,original:m,selectedIndex:-1,selectedItem:null,selectedData:null};p.data("ddslick",t);
					if(l.selectText.length>0&&l.defaultSelectedIndex==null){
						p.find(".dd-selected").html(l.selectText)
					}else{
						var r=(l.defaultSelectedIndex!=null&&l.defaultSelectedIndex>=0&&l.defaultSelectedIndex<l.data.length)?l.defaultSelectedIndex:0;j(p,r)}p.find(".dd-select").on("click.ddslick",function(){f(p)});
	...
	return this.each(function(){
		...
		c.close=function(){
			...
			c.destroy=function(){
				...
				function j(q,s){var u=q.data("ddslick");
