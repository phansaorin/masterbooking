...
class Mod_customize extends MU_Model{
    ...
    */
    ...
    /*
    * public function getSubActCus
    * @param $actID
    * @table transportation, acc_calendar calendar_available
    * return object DB
    */
    public function getSubActCus($actID){
    ...
    /*
    * public function getSubAccCus
    * @param $accID
    * @table accommodation, acc_calendar and calendar_available
    * return object DB
    */
    public function getSubAccCus($accID){
    ...
    /*
    * public function getSubTpsCus
    * @param $tpsID
    * @table accommodation, acc_calendar and calendar_available
    * return object DB
    */
    public function getSubTpsCus($tpsID){
    ...
    /*
    * public function getSubEpCus
    * @param $actID
    * @table extra_acti, extraproduct, extraproduct_calendar
    * return object DB
    */
    public function getSubEpCus($actID){
    ...
    /*
    * public function getSubEpAccCus
    * @param $accID
    * @table extra_acc, extraproduct, extraproduct_calendar
    * return object DB
    */
    public function getSubEpAccCus($accID){
        $query_ep = $this->db->select("*")
    ...
    /*
    * public function getSubEpTpsCus
    * @param $tpsID
    * @table extra_transport, extraproduct, extraproduct_calendar
    * return object DB
    */
    public function getSubEpTpsCus($tpsID){
        $query_ep = $this->db->select("*")
    ...
    * return 
    */
    public function updateCustomize($update, $cus_id){
        $this->db->where('cuscon_id', $cus_id);
        if($this->db->update('customize_conjection',$update)){ return true; }else{ return false; }
    }
    ...
    */
    ...
    /*
    * public function getActivitiesFromCus
    * @param $act_id (int)
    * @table acti_calendar, activities, calendar_available, location, supplier, festival
    * return object record
    */
    public function getActivitiesFromCus($act_id){
        $query = $this->db->select("*")                
    ...
    */
    ...
    /*
    * public function getSubActivitiesFromCus
    * @param $act_id (array)
    * @table acti_calendar, activities, calendar_available
    * @where_in
    * return object record
    */
    public function getSubActivitiesFromCus($act_id){
        $query = $this->db->select("*")                
                ->join('location', 'location.lt_id = activities.location_id', 'left')
                ->join('supplier', 'supplier.sup_id = activities.act_supplier_id', 'left')
                ->join('festival', 'festival.ftv_id = activities.act_ftv_id', 'left')
    ...
    /*
    * public function getSubTranpsportsFromCus
    * @param $tpsID (int)
    * @table location, supplier, festival, tp_calendar, calendar_available, photo, transportation
    * return object record
    */
    public function getSubTranpsportsFromCus($tpsID){
        $query = $this->db->select("*")
            ->join('location', 'location.lt_id = transportation.tp_pickuplocation', 'left')
            ->join('supplier', 'supplier.sup_id = transportation.tp_supplier_id', 'left')
            ->join('festival', 'festival.ftv_id = transportation.tp_ftv_id', 'left')
    ...
    /*
    * public function getSubaccommodationsFromCus
    * @param $subAcc (array)
    * @table accommodation,room_types, classification, location, festival, acc_calendar, calendar_available, photo
    * @where_in
    * return object record
    */
    public function getSubaccommodationsFromCus($subAcc){
        $query = $this->db->select("*")                
                ->join('room_types', 'room_types.rt_id = accommodation.acc_rt_id', 'left')
                ->join('classification', 'classification.clf_id = accommodation.classification_id', 'left')
                ->join('location', 'location.lt_id = accommodation.location_id', 'left')
    ...
    /*
    * public function getExtraproductFromCus
    * @param $ep_id (array)
    * @table , calendar_available
    * @where_in
    * return object record
    */
    public function getExtraproductFromCus($ep_id){
        $query = $this->db->select("*")                 
    ...
    * return affected row.
    */
    public function updateActivitiesCustomize($activities, $cus_id){
    ...
    * return affected row.
    */
    public function updateAccommodationsCustomize($accommodations, $cusID){
        $update['cuscon_accomodation'] = $accommodations;
        $this->db->where('cuscon_id', $cusID);
        return $this->db->update('customize_conjection',$update);
    }
    /*
    ...
    * @param $cusID (int)
    * @table customize_conjection 
    * @colum cus_transportation
    * return affected row.
    */
    public function updateTransportationCustomize($transportation, $cusID){
    ...
    * return object.
    */
    public function getActivitiesCustomize($cus_id){
        $querycusact = $this->db->select('cuscon_activities')
            ->where('cuscon_id', $cus_id)
            ->get('customize_conjection');
        return $querycusact;
    }
    ...
    * return object.
    */
    public function getAccommodationCustomize($cus_id){
        $querycusacc = $this->db->select('cuscon_accomodation')
            ->where('cuscon_id', $cus_id)
            ->get('customize_conjection');
        return $querycusacc;
    }
    ...
    * return object.
    */
    public function getTransportCustomize($cus_id){
        $querycusacc = $this->db->select('cus_transportation')
            ->where('cuscon_id', $cus_id)
            ->get('customize_conjection');
        return $querycusacc;
    }
