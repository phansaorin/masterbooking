<?php  echo form_open_multipart('accommodation/view_accommodation/'.$this->uri->segment(3), 'class="form-horizontal view_accommodation"'); ?>
<ol class="breadcrumb">
    <li><?php echo anchor("munich_admin","Dashboard"); ?></li>
    <li><?php echo anchor("accommodation/list_record","Manage Accommodation"); ?></li>
    <li>View Accommodation</li>
</ol>
<h1 class="action_page_header"><b>View Accommodation</b></h1>
<?php
$facChecked = array();
    if($getUpdateAccommodation->num_rows() > 0){
        foreach($getUpdateAccommodation->result() as $value){
            ...
            $ftv        = $value->acc_ftv_id;
            $chosimg    = $value->photo_id;
            $orContract = $value->acc_hoteldate;
            $payed      = $value->acc_payeddate;
            $deadline   = $value->acc_deadline;
            $status     = $value->acc_status;
            $txtadmin   = $value->acc_admintext;
            $spl   = $value->acc_supplier_id;
            $acc_texteticket   = $value->acc_texteticket;
            $acc_purchaseprice = $value->acc_purchaseprice;
            $acc_saleprice     = $value->acc_saleprice;
            $acc_actualstock   = $value->acc_actualstock;
            $acc_originalstock = $value->acc_originalstock;
            $acc_name          = $value->acc_name;
            $acc_bookingtext   = $value->acc_bookingtext;
            $facilities = $value->accomodations_id;
            ...
            $cal_id          = $value->ca_id;
            $ficility_id      = $value->accfac_id;
            $ficilties_id    =  $value->facilities_id;
            $accommodation    = $value->acc_id;
           // echo $ficility_id; die();
            if(count($facChecked) > 0){
                if(! array_search($value->facilities_id, $facChecked)){
                   $facChecked[$value->facilities_id] = $value->facilities_id;  
                }
            }else{
               $facChecked[$value->facilities_id] = $value->facilities_id; 
            }
    ...
    echo form_hidden('acc_id', $accommodation);
    echo form_hidden('fici_id', $ficilties_id);

    echo form_hidden('cal_id', $cal_id);
    echo form_hidden('ficility_id', $ficility_id);
    echo form_hidden('acc_subof', $this->uri->segment(3));
    echo form_hidden('sub_deteted', base_url()."accommodation/deleted_sub");
?>
...
<div class="row">
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <?php
                $accommodationName = array('name' =>'accommodationName','value'=> set_value('accommodationName',$acc_name),'class' => 'form-control');
     ...
     <div class="form-group">
        ...
        <?php
            ...
            foreach($get_facility->result() as $value){
                ...
                //echo array_search($value->facilities_id, $facChecked);
                if(array_search($value->facilities_id, $facChecked)){
                    $check = true;
                }
        ...
        ?>
        <?php 
        echo form_checkbox(array('name' => 'txtFaciliti[]','value' => $value->facilities_id,'checked'=> $check)); ?> </br>
    <?php
        $check = false;
       }
     }
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            ...
            echo form_dropdown('txtRoom', $roomtypes,$room_type, 'class="form-control"');  
            ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            ...
            echo form_dropdown('txtClassification', $classification,$cft, 'class="form-control"');  
            ?>
            <span style="color:red;"><?php echo form_error('txtLocation'); ?></span>
        </div>
    </div>
    <!-- end of new of room and cifility -->
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <?php
                $purchasePrice = array('name' => 'purchasePrice','class' => 'form-control', 'value' => set_value('purchasePrice',$acc_purchaseprice));
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <?php
                $salePrice = array('name' => 'salePrice','class' => 'form-control','value' => set_value('salePrice',$acc_saleprice));
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <?php
                $originalStock = array('name' => 'originalStock','class' => 'form-control', 'value' => set_value('originalStock',$acc_originalstock));
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <?php
                $actualStock = array('name' => 'actualStock','class' => 'form-control', 'value' => set_value('actualStock',$acc_actualstock));
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <?php 
                $txtBooking = array('name'=>'txtBooking', 'class' => 'form-control textarea', 'value' => set_value('txtBooking', $acc_bookingtext),"rows" => 3);
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <?php
                $txtEticket = array('name'=>'txtEticket', 'class' => 'form-control textarea', 'value' => set_value('txtEticket',$acc_texteticket),"rows" => 3); 
    ...
    <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
            <?php 
                echo form_submit('SaveChangeAccommodation', 'Save Change',"class='btn btn-primary btn-md check_value acc_save_change'");
                echo ' '.nbs(1);
                echo form_button('SaveChangeAccommodation', 'Add Sub Accommodation', "class='btn btn-primary btn-md check_value addsub' data-toggle='modal' data-target='.modal-subaccommodation' ");
                echo ' '.nbs(1);
                echo form_button('SaveChangeAccommodation', 'Add Product', "class='btn btn-primary btn-md check_value addpro' data-toggle='modal' data-target='.modal-extraproduct' ");
                echo ' '.nbs(1);
                echo anchor('accommodation/list_record', 'Back', "class='btn btn-primary'")
            ?>
            <p style="display:none; color:red">Some Field is wrong!... Please check Data Again before you submit.</p>
        </div>
    </div>
</div>
<!-- include the sub accommodation list here -->
<?php $this->load->view(INCLUDE_BE.$this->uri->segment(1).'/list_subaccommodation'); ?>
<!-- include the extraproducts list here -->
<?php $this->load->view(INCLUDE_BE.$this->uri->segment(1).'/list_extraproducts'); ?>
<?php echo form_close(); ?>
</div>
<!-- modal for add new sub accommodation -->
<?php $this->load->view(INCLUDE_BE.'modal/sub_acc_pro'); ?>
<!-- modal for detail -->
