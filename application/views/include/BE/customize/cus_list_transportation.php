<h4>Transportation &nbsp; &nbsp; <span class="cusaddtransport cusadd btn-info btn-sm" data-toggle='modal' data-target='.modal-cusaddtransport'>Add Transportation</span></h4>
	...
	<div class="panel panel-default">
		<div class="panel-heading">
	      <div class="panel-title">
	        ...
	        <span class="icon-list-alt cusadd clickDetailtp" data-url="<?php echo base_url(); ?>customize/tpdetail/<?php echo $tpsID; ?>/<?php echo $this->uri->segment(3); ?>" data-toggle='modal' data-target='.modalDetials' title="Details" style="float:right; margin-left:5px;"></span>
	      ...
	      <div class="panel-body">
	      	<?php 
	      		if(isset($customize_transportation['sub-transport'][$tpsID])){
	      			...
	      			$data['tpsID'] = $tpsID;
	      			$this->load->view(INCLUDE_BE.$this->uri->segment(1).'/list_cus_subtransportation', $data);
	      		} 
	      	?>
	      	<?php 
	      		if(isset($customize_transportation['extraproduct-cus'][$tpsID])){
	      			$extraproduct['extraproduct_cus'] = $customize_transportation['extraproduct-cus'][$tpsID];
