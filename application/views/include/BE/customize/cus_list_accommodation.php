<h4>Accommodation &nbsp; &nbsp; <span class="cusaddaccommocation cusadd btn-info btn-sm" data-toggle='modal' data-target='.modal-cusaddaccommocation'>Add Accommodation</span></h4>
	...
	<div class="panel panel-default">
		<div class="panel-heading">
	      <div class="panel-title">
	        ...
	        <span class="icon-list-alt cusadd clickDetailacc" data-url="<?php echo base_url(); ?>customize/accdetail/<?php echo $accID; ?>/<?php echo $this->uri->segment(3); ?>" data-toggle='modal' data-target='.modalDetials' title="Details" style="float:right; margin-left:5px;"></span>
	    ...
	    <div id="acc<?php echo $accID; ?>" class="panel-collapse collapse">
	      <div class="panel-body">
	      	...
	      	?>
	      	<?php 
	      		if(isset($customize_accomodation['extraproduct-cus'][$accID])){
	      			$extraproduct['extraproduct_cus'] = $customize_accomodation['extraproduct-cus'][$accID];
