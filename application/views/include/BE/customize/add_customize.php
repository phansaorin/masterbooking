...
<h1 class="action_page_header">Create New Customize</h1>
<div class="row">
    <?php  echo form_open_multipart('customize/add_customize', 'class="form-horizontal add_customize"'); ?>
        <div class="form-group">
            <label class="col-sm-2 control-label">Name <span class="require">*</span> :</label>
            <div class="col-sm-4">
                <?php
                $customizeName = array('name' =>'cusName','value'=> set_value('cusName'),'class' => 'form-control');
        ...
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
              <?php 
                echo form_submit('addCustomize', 'Add',"class='btn btn-primary btn-md check_value'");
                echo ' '.nbs(1);
                echo anchor('customize/list_record', 'Cancel', "class='btn btn-primary btn-sm'");
              ?>
            </div>
        </div>
    <?php echo form_close(); ?>
