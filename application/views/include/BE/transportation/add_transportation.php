<?php  echo form_open_multipart('transportation/add_transportation', 'class="form-horizontal add_transportation"'); ?>
<ol class="breadcrumb">
  <li><?php echo anchor("munich_admin","Dashboard"); ?></li>
  <li><?php echo anchor("transportation/list_record","Manage Transporation"); ?></li>
  <li>Add</li>
</ol>
<h1 class="action_page_header">Create New Transportation</h1>
<?php
...
<div class="row">
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <?php
                $ativitiesName = array('name' =>'transportationName','value'=> set_value('transportationName'),'class' => 'form-control');
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <?php
                $Arrivaldate = array( 'id'=>'dp6','name' => 'txtArrivalDate', 'class' => 'form-control','data-date-format'=>'yyyy-mm-dd','style'=>'', 'value' => set_value('txtArrivalDate'));
    ...
    <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
            <?php 
                echo form_submit('addTransportation', 'Add',"class='btn btn-primary btn-md check_value'");
                echo ' '.nbs(1);
                echo anchor('transportation/list_record', 'Cancel', "class='btn btn-primary btn-sm'");
            ?>
