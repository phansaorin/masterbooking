...
$content = '<table width="500" cellpadding="0" cellspacing="0" border="1" style="text-align:center; margin-top: 5px;">
        <thead>
                <tr bgcolor="#FFDEAD" color="black">
                    ...
                    <th><font size="11">Activities Name</font></th>
...
?>
        ...
        foreach ($activities as $data):
            $content .= '<tr><td  width="40">'.$id++.'</td>
                        ...
                        <td>'.$data->lt_name.'</td>
                        <td width="55">'.$data->act_purchaseprice.'</td>
                        <td width="55">'.$data->act_saleprice.'</td>
                        <td width="55">'.$data->act_originalstock.'</td>
                        <td width="55">'.$data->act_actualstock.'</td></tr>';
            ?>
        <?php endforeach; 
        $content .= '<tbody></table>'; ?>
<?php
