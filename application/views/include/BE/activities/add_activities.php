<?php  echo form_open_multipart('activities/add_activities', 'class="form-horizontal add_activities"'); ?>
<ol class="breadcrumb">
  <li><?php echo anchor("munich_admin","Dashboard"); ?></li>
  <li><?php echo anchor("activities/list_record","Manage Activities"); ?></li>
  <li>Add</li>
</ol>
<h1 class="action_page_header">Create New Activity</h1>
<?php
...
<div class="row">
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <?php
                $ativitiesName = array('name' =>'activitiesName','value'=> set_value('activitiesName'),'class' => 'form-control');
    ...
    <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
            <?php 
                echo form_submit('addActivity', 'Add',"class='btn btn-primary btn-md check_value'");
                echo ' '.nbs(1);
                echo anchor('activities/list_record', 'Cancel', "class='btn btn-primary btn-sm'");
            ?>
