<?php
    ...
    if($this->session->userdata('searchBooking')) $this->session->set_userdata('searchBooking')
  ?>
<ol class="breadcrumb">
...
<table class="table table-striped table-hover table-bordered">
    <tr> 
        ...
        <th width="7%"><?php echo anchor("booking/list_record/ID/" . $sort, "ID"); ?></th>
        <th>Date</th>
        <th>Arrival</th>
        <th>Paid</th>
        <th>Price($)</th>
